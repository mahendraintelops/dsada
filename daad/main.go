...
import (
	...
	"github.com/mahendraintelops/dsada/daad/config"
	restcontrollers "github.com/mahendraintelops/dsada/daad/pkg/rest/server/controllers"
...
func main() {
	...
	qeqeqeController, err := restcontrollers.NewQeqeqeController()
	if err != nil {
	...
	v1 := router.Group("/v1")
	{
		...
		v1.POST("/qeqeqes", qeqeqeController.CreateQeqeqe)

		v1.GET("/qeqeqes", qeqeqeController.ListQeqeqes)
